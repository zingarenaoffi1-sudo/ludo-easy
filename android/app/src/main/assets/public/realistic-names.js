// Realistic Player Identity & Persona Generator for Ludo
// Gives each opponent a genuine human feel with unique names, avatars, rank badges, and chat responses.
...
window.RealisticPersonas = (function() {
    ...
    function triggerBotChatReaction(senderColor, triggerType = 'normal') {
        ...
        // Show floating bubble over profile card
